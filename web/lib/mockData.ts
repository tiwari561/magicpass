...
// Extended broker list for the broker management page
export const MOCK_BROKERS: Broker[] = [
  { ...MOCK_BROKER, id: 'b1', name: 'Arjun Kapoor', initials: 'AK', reraNumber: 'A52100000089', visitsCount: 34, status: 'verified' },
  { ...MOCK_BROKER, id: 'b2', name: 'Priya Mehta', initials: 'PM', reraNumber: 'A52100000142', company: 'Prime Realty Co.', email: 'priya.m@primerealty.in', visitsCount: 28, status: 'verified' },
  { ...MOCK_BROKER, id: 'b3', name: 'Vikram Singh', initials: 'VS', reraNumber: 'A52103001077', company: 'VS Properties', email: 'vikram@vsproperties.in', visitsCount: 19, status: 'pending' },
  { ...MOCK_BROKER, id: 'b4', name: 'Sneha Nair', initials: 'SN', reraNumber: 'A52104000321', company: 'Nair Realtors', email: 'sneha@nairrealtors.in', visitsCount: 42, status: 'verified' },
  { ...MOCK_BROKER, id: 'b5', name: 'Rahul Joshi', initials: 'RJ', reraNumber: 'A52105000555', company: 'Joshi Estates', email: 'rahul@joshiestates.in', visitsCount: 11, status: 'pending' },
  { ...MOCK_BROKER, id: 'b6', name: 'Kavya Reddy', initials: 'KR', reraNumber: 'A52106000789', company: 'Kavya Properties', email: 'kavya@kavyaprops.in', visitsCount: 7, status: 'blacklisted' },
  { ...MOCK_BROKER, id: 'b7', name: 'Manish Trivedi', initials: 'MT', reraNumber: 'A52107000234', company: 'Trivedi Realty', email: 'manish@trivedirealty.in', visitsCount: 56, status: 'verified' },
  { ...MOCK_BROKER, id: 'b8', name: 'Anita Desai', initials: 'AD', reraNumber: 'A52108000456', company: 'Desai & Co.', email: 'anita@desaico.in', visitsCount: 23, status: 'pending' },
  { ...MOCK_BROKER, id: 'b9', name: 'Suresh Patel', initials: 'SP', reraNumber: 'A52109000678', company: 'Patel Homes', email: 'suresh@patelhomes.in', visitsCount: 31, status: 'verified' },
  { ...MOCK_BROKER, id: 'b10', name: 'Deepika Sharma', initials: 'DS', reraNumber: 'A52110000901', company: 'Sharma Realtors', email: 'deepika@sharmarealtors.in', visitsCount: 15, status: 'blacklisted' },
  { ...MOCK_BROKER, id: 'b11', name: 'Karan Malhotra', initials: 'KM', reraNumber: 'A52111001123', company: 'Malhotra Props', email: 'karan@malhotraprops.in', visitsCount: 38, status: 'verified' },
  { ...MOCK_BROKER, id: 'b12', name: 'Pooja Iyer', initials: 'PI', reraNumber: 'A52112001345', company: 'Iyer Estates', email: 'pooja@iyerestates.in', visitsCount: 9, status: 'pending' },
];
